...
| **Vision** |
| `vision/adapters/protocols.py` | DetectorAdapter, TrackerAdapter, ReIdAdapter | Member 1 | IMPLEMENTED | — | Protocol definitions | Contracts | Member 1 |
...
| `vision/ingestion/` | Video file loading | Member 1 | SCAFFOLDED | Video | Frames | — | Member 1 |
| `vision/pipeline/` | End-to-end vision runner | Member 1 | PLANNED | Video | Evidences | All vision modules | Member 1 |
| **Intelligence** |
| `intelligence/interfaces.py` | All graph/engine interfaces | Member 2 | IMPLEMENTED | — | Protocol definitions | Contracts | Member 2 |
...
| **Agent / Storage / AWS** |
| `agent/interfaces.py` | LLMClient, Investigator, Verifier | Member 3 | IMPLEMENTED | — | Protocol definitions | Contracts | Member 3 |
...
| `storage/` | DB adapters | Member 3 | SCAFFOLDED | — | — | — | Member 3 |
| `infra/aws/cdk/` | CDK infrastructure | Member 3 | PLANNED | — | — | — | Member 3 |
| **API** |
...
| `apps/web/src/services/types.ts` | Frontend type re-exports | Member 4 | IMPLEMENTED | — | Types | Contracts | Member 4 |
...
| `apps/web/src/features/investigation/`| Query/Replay | Member 4 | PLANNED | UI | UI | api.ts | Member 4 |
| `apps/web/src/features/trajectory/`| Trajectory view | Member 4 | PLANNED | UI | UI | api.ts | Member 4 |
| **Mock Data** |
